"use strict";(()=>{var je=Object.create;var be=Object.defineProperty;var Oe=Object.getOwnPropertyDescriptor;var Ne=Object.getOwnPropertyNames;var Ye=Object.getPrototypeOf,Ze=Object.prototype.hasOwnProperty;var We=(r=>typeof require!="undefined"?require:typeof Proxy!="undefined"?new Proxy(r,{get:(e,t)=>(typeof require!="undefined"?require:e)[t]}):r)(function(r){if(typeof require!="undefined")return require.apply(this,arguments);throw new Error('Dynamic require of "'+r+'" is not supported')});var Ge=(r,e,t,n)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Ne(e))!Ze.call(r,s)&&s!==t&&be(r,s,{get:()=>e[s],enumerable:!(n=Oe(e,s))||n.enumerable});return r};var Je=(r,e,t)=>(t=r!=null?je(Ye(r)):{},Ge(e||!r||!r.__esModule?be(t,"default",{value:r,enumerable:!0}):t,r));function Se(r){var e=r.split(".")[1],t=e.replace(/-/g,"+").replace(/_/g,"/"),n=decodeURIComponent(atob(t).split("").map(function(s){return"%"+("00"+s.charCodeAt(0).toString(16)).slice(-2)}).join(""));return JSON.parse(n)}var Ce="https://js.stripe.com/v3",Ke=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,xe="loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used",Xe=function(){for(var e=document.querySelectorAll('script[src^="'.concat(Ce,'"]')),t=0;t<e.length;t++){var n=e[t];if(Ke.test(n.src))return n}return null},Qe=function(e){var t=e&&!e.advancedFraudSignals?"?advancedFraudSignals=false":"",n=document.createElement("script");n.src="".concat(Ce).concat(t);var s=document.head||document.body;if(!s)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return s.appendChild(n),n},et=function(e,t){!e||!e._registerWrapper||e._registerWrapper({name:"stripe-js",version:"2.1.7",startTime:t})},G=null,tt=function(e){return G!==null||(G=new Promise(function(t,n){if(typeof window=="undefined"||typeof document=="undefined"){t(null);return}if(window.Stripe&&e&&console.warn(xe),window.Stripe){t(window.Stripe);return}try{var s=Xe();s&&e?console.warn(xe):s||(s=Qe(e)),s.addEventListener("load",function(){window.Stripe?t(window.Stripe):n(new Error("Stripe.js not available"))}),s.addEventListener("error",function(){n(new Error("Failed to load Stripe.js"))})}catch(o){n(o);return}})),G},nt=function(e,t,n){if(e===null)return null;var s=e.apply(void 0,t);return et(s,n),s},ke=Promise.resolve().then(function(){return tt(null)}),Te=!1;ke.catch(function(r){Te||console.warn(r)});var oe=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];Te=!0;var s=Date.now();return ke.then(function(o){return nt(o,t,s)})};var st=window.location.host.includes("webflow")?"stage":"prod",m=`https://${st}.ai-or-not.com`,J="https://results.aiornot.com",F=class{constructor(e,t){this.apiUrl=e,this.bearerToken=t}async get(e){let t=`${this.apiUrl}/${e}`;try{let n=await fetch(t,{method:"GET",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.bearerToken}`}});return await this.handleResponse(n)}catch(n){throw console.error("Error",n),n}}async post(e,t){let n=`${this.apiUrl}/${e}`;try{let s=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.bearerToken}`},body:JSON.stringify(t)});return await this.handleResponse(s)}catch(s){throw console.error("Request error",s),s.status===429&&s.message.msg.type==="requests"&&alert(`It looks like you have reached your plan limit of ${s.message.msg.current_limit} requests. To continue, please upgrade to a new plan.`),s}}async postBinary(e,t){let n=`${this.apiUrl}/${e}`;try{let s=await fetch(n,{method:"POST",headers:{Accept:"application/json",Authorization:`Bearer ${this.bearerToken}`},body:t});return await this.handleResponse(s)}catch(s){throw console.error("Binary request error:",s),s.status===429&&s.message.msg.type==="requests"&&alert(`It looks like you have reached your plan limit of ${s.message.msg.current_limit} requests. To continue, please upgrade to a new plan.`),s}}async delete(e){let t=`${this.apiUrl}/${e}`;try{let n=await fetch(t,{method:"DELETE",headers:{accept:"*/*",Authorization:`Bearer ${this.bearerToken}`}});await this.handleResponse(n)}catch(n){throw console.error("Error when perform DELETE-request:",n),n}}async patch(e,t){let n=`${this.apiUrl}/${e}`;try{let s=await fetch(n,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.bearerToken}`},body:JSON.stringify(t)});return await this.handleResponse(s)}catch(s){throw console.error("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u0438 PATCH-\u0437\u0430\u043F\u0440\u043E\u0441\u0430:",s),s}}async handleResponse(e){if(!e.ok){let t=await e.json();throw{status:e.status,message:t}}if(e.status!==204)return await e.json()}};var ot=`
#toast {
...
@keyframes fadeout {
  from {top: 30px; opacity: 1;}
  to {top: 0; opacity: 0;}
`,qe=document.createElement("style");qe.innerHTML=ot;document.head.appendChild(qe);var O=document.getElementById("toast");function rt(r){O.classList.remove("hide");let e=document.createElement("span");e.innerHTML="x",e.className="close-button",e.addEventListener("click",()=>{O.classList.add("hide"),window.location.href=`https://${window.location.host}/dashboard/settings`}),O.innerHTML=r,O.appendChild(e),O.classList.add("show")}var _e=(r,e)=>{rt(`<p style="font-size: 1.5rem; padding: 2rem;">We are pleased to inform you that you currently have a credit of $${r} from a previous paid subscription after that we successfully update your plan to <span style="color: #aefc06; font-weight: bold ">${e.split(" ")[0]}</span>! If you have any questions please contact us.</p>`)};var Ie=`
...
@media (min-width: 576px) {
  ...
  .payment-form .card-details button {
    margin-top: 2em;
            ...
            `,j=class{constructor(){this.elements=null;this.stripe=null;this.home_element=document.querySelector("#home");this.PRODUCT_ID_BASE_PLAN={id:"price_1O2Ba4Ba9yG4sk8k4y3ZnEVT",msg:"Base plan: $30/month",name:"Base plan",description:"1,000 requests per month",price:"$30",test_id:"price_1O1wSsBa9yG4sk8kej8shNYs"};this.PRODUCT_ID_PRO_PLAN={id:"price_1O2Ku4Ba9yG4sk8kIQBdzpPj",msg:"Pro plan: $250/month",name:"Pro plan",description:"10,000 requests per month",price:"$250",test_id:"price_1O7HCzBa9yG4sk8kYEld9lNl"};this.is_test_mode=!1}showBlinkMessage(e,t){let n=document.createElement("style");n.innerHTML=Ie,document.head.appendChild(n),t.innerHTML=`
...
<span> Free Research Preview. AI or Not may produce inaccurate results </span>
</div>`,document.getElementById("ai-or-not_result-message-50").classList.add("hide"),document.getElementById("ai-or-not_result-message").classList.remove("hide"),document.querySelector("#ai-or-not_model-name").textContent=i,i==="ai"?(document.getElementById("title-human").classList.add("hide"),document.getElementById("title-ai").classList.remove("hide")):(document.getElementById("title-human").classList.remove("hide"),document.getElementById("title-ai").classList.add("hide")))},ge=async()=>{if(A.isLimitExceeded()){let i=document.getElementById("sign-up");i.style.display="flex",i.style.zIndex=100,V()}else d.classList.add("hide"),pe(),await T.getReportsByUrl(u,Q).then(i=>{A.increment(),le(i.id),b.src=u,ye(i.verdict),he(i.nsfw_detected)}).catch(i=>{L.classList.contains("hide")?ue():(ue(),V())})},B=document.body,yt=document.querySelector("#dropzone-fullscreen_message-tip"),gt=document.querySelector("#dropzone-fullscreen_message-format");B==null||B.addEventListener("dragover",function(i){i.preventDefault(),document.querySelector(".dropzone-fullscreen").classList.remove("hide")}),B==null||B.addEventListener("dragleave",function(i){i.preventDefault(),document.querySelector(".dropzone-fullscreen").classList.add("hide")}),B==null||B.addEventListener("drop",async function(i){if(f()!=="image")return;i.preventDefault(),document.querySelector(".dropzone-fullscreen").classList.add("hide");let y=i.dataTransfer.files[0],D=y.size,C=10*1024*1024;D>C?(x=!1,W()):(x=!0,de()),x==!0?await fe(y):W()}),h==null||h.addEventListener("change",async i=>{if(x==!0){let y=h;console.log(y);let D=y.files[0];await fe(D)}else W()});let fe=async i=>{if(pe(),A.isLimitExceeded()){let C=document.getElementById("sign-up");C.style.display="flex",C.style.zIndex=100,V();return}let y=document.querySelector("#ai-or-not-current-image"),D=URL.createObjectURL(i);y.setAttribute("src",D),b.classList.remove("hide"),w.classList.add("hide"),await T.getReportsByBinary(i,Q).then(C=>{A.increment(),le(C.id),me(),ye(C.verdict),he(C.nsfw_detected)}).catch(C=>{Ve(),V()})};v==null||v.addEventListener("click",function(){me(),V()}),(Ee=document.querySelector("#ai-or-not_dropzone"))==null||Ee.addEventListener("click",function(){f()==="image"&&(l.checkAuth(V)||(q="screen_home",h.click()))}),(Le=document.querySelector("#choose-file-row"))==null||Le.addEventListener("click",function(){f()==="image"&&(q="screen_result",h.click())}),P==null||P.addEventListener("click",()=>{S.value!=""&&(u=S.value,ge())});let ne=document.querySelector("#ai-or-not_image-url");ne==null||ne.addEventListener("keypress",function(i){i.key==="Enter"&&S.value!=""&&(u=S.value,ge())}),c.forEach(i=>{i==null||i.addEventListener("click",()=>{let y=i.getAttribute("test-image-url");document.querySelector("#ai-or-not_image-url").value=y,document.querySelector("#image-url-aion-submit").click(),document.querySelector("#ai-or-not_image-url").value=""})}),s==null||s.addEventListener("click",()=>{Ue(),T.sendFeedback(z,!0,"")}),o==null||o.addEventListener("click",()=>{}),a==null||a.addEventListener("click",()=>{}),t==null||t.addEventListener("click",()=>{T.sendFeedback(z,!1,n.value),Z()}),document==null||document.addEventListener("keydown",function(i){i.code==="Escape"&&e.style.display!=="none"&&a.click()}),n==null||n.addEventListener("change",()=>{n.value!=""?t.classList.remove("is-disabled"):t.classList.add("is-disabled")}),n==null||n.addEventListener("input",()=>{n.value!=""?t.classList.remove("is-disabled"):t.classList.add("is-disabled")});let ve=document.querySelector("#ai-or-not_image-url"),we=document.querySelector("#image-url-aion-submit");ve.addEventListener("input",function(){let i=ve.value.trim();De(i)?we.classList.remove("is-disabled"):we.classList.add("is-disabled")});let De=i=>{try{return new URL(i),!0}catch{return!1}},se=document.getElementById("close-sign-up");se==null||se.addEventListener("click",()=>{let i=document.getElementById("sign-up");i.style.display="none",i.style.zIndex=0}),N(document.querySelector("#image-quotas"))};var ce=()=>{let r=new j,e=document.querySelector("#bt-pay-free"),t=document.querySelector("#bt-pay-basic"),n=document.querySelector("#bt-pay-pro"),s=document.querySelector("#bt-pay-enterprice");e==null||e.addEventListener("click",()=>{localStorage.getItem("_ms-mid")?window.location.href=`https://${window.location.host}/`:window.location.href=`https://${window.location.host}/signup`}),t==null||t.addEventListener("click",()=>{if(!localStorage.getItem("_ms-mid")){window.location.href=`https://${window.location.host}/signup`;return}r.checkout(r.PRODUCT_ID_BASE_PLAN)}),n==null||n.addEventListener("click",()=>{if(!localStorage.getItem("_ms-mid")){window.location.href=`https://${window.location.host}/signup`;return}r.checkout(r.PRODUCT_ID_PRO_PLAN)}),s==null||s.addEventListener("click",()=>{window.location.href=`https://${window.location.host}/contact-us`})};var ht=()=>{Be()};ht();$e();He();ce();})();
