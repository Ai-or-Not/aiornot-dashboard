"use strict";(()=>{var h="https://js.stripe.com/v3",k=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,u="loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used",_=function(){for(var e=document.querySelectorAll('script[src^="'.concat(h,'"]')),t=0;t<e.length;t++){var o=e[t];if(k.test(o.src))return o}return null},v=function(e){var t=e&&!e.advancedFraudSignals?"?advancedFraudSignals=false":"",o=document.createElement("script");o.src="".concat(h).concat(t);var n=document.head||document.body;if(!n)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return n.appendChild(o),o},S=function(e,t){!e||!e._registerWrapper||e._registerWrapper({name:"stripe-js",version:"2.1.7",startTime:t})},p=null,P=function(e){return p!==null||(p=new Promise(function(t,o){if(typeof window=="undefined"||typeof document=="undefined"){t(null);return}if(window.Stripe&&e&&console.warn(u),window.Stripe){t(window.Stripe);return}try{var n=_();n&&e?console.warn(u):n||(n=v(e)),n.addEventListener("load",function(){window.Stripe?t(window.Stripe):o(new Error("Stripe.js not available"))}),n.addEventListener("error",function(){o(new Error("Failed to load Stripe.js"))})}catch(i){o(i);return}})),p},T=function(e,t,o){if(e===null)return null;var n=e.apply(void 0,t);return S(n,o),n},f=Promise.resolve().then(function(){return P(null)}),y=!1;f.catch(function(r){y||console.warn(r)});var m=function(){for(var e=arguments.length,t=new Array(e),o=0;o<e;o++)t[o]=arguments[o];y=!0;var n=Date.now();return f.then(function(i){return T(i,t,n)})};var E=window.location.host.includes("webflow")?"stage":"prod",a=`https://${E}.ai-or-not.com`;var $=`
#toast {
