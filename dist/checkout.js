"use strict";(()=>{var u="https://js.stripe.com/v3",v=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,h="loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used",k=function(){for(var e=document.querySelectorAll('script[src^="'.concat(u,'"]')),t=0;t<e.length;t++){var o=e[t];if(v.test(o.src))return o}return null},_=function(e){var t=e&&!e.advancedFraudSignals?"?advancedFraudSignals=false":"",o=document.createElement("script");o.src="".concat(u).concat(t);var n=document.head||document.body;if(!n)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return n.appendChild(o),o},S=function(e,t){!e||!e._registerWrapper||e._registerWrapper({name:"stripe-js",version:"2.1.7",startTime:t})},p=null,P=function(e){return p!==null||(p=new Promise(function(t,o){if(typeof window=="undefined"||typeof document=="undefined"){t(null);return}if(window.Stripe&&e&&console.warn(h),window.Stripe){t(window.Stripe);return}try{var n=k();n&&e?console.warn(h):n||(n=_(e)),n.addEventListener("load",function(){window.Stripe?t(window.Stripe):o(new Error("Stripe.js not available"))}),n.addEventListener("error",function(){o(new Error("Failed to load Stripe.js"))})}catch(i){o(i);return}})),p},T=function(e,t,o){if(e===null)return null;var n=e.apply(void 0,t);return S(n,o),n},f=Promise.resolve().then(function(){return P(null)}),y=!1;f.catch(function(r){y||console.warn(r)});var m=function(){for(var e=arguments.length,t=new Array(e),o=0;o<e;o++)t[o]=arguments[o];y=!0;var n=Date.now();return f.then(function(i){return T(i,t,n)})};var $=window.location.host.includes("webflow")?"stage":"prod",a=`https://${$}.ai-or-not.com`;var E=`
#toast {
...
@media (min-width: 576px) {
  ...
  .payment-form .card-details button {
    margin-top: 2em;
            ...
            `,d=class{constructor(){this.elements=null;this.stripe=null;this.home_element=document.querySelector("#home");this.PRODUCT_ID_BASE_9USD_PLAN={id:"base-plan",msg:"Base plan: $9/month",name:"Base plan",description:"300 requests per month",price:"$9",test_id:"base-plan"};this.PRODUCT_ID_PRO_PLAN={id:"pro-plan",msg:"Pro plan: $250/month",name:"Pro plan",description:"10,000 requests per month",price:"$250",test_id:"pro-plan"};this.is_test_mode=!1}showBlinkMessage(e,t){let o=document.createElement("style");o.innerHTML=b,document.head.appendChild(o),t.innerHTML=`
