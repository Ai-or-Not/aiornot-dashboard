"use strict";(()=>{var h="https://js.stripe.com/v3",w=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,m="loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used",b=function(){for(var e=document.querySelectorAll('script[src^="'.concat(h,'"]')),t=0;t<e.length;t++){var r=e[t];if(w.test(r.src))return r}return null},k=function(e){var t=e&&!e.advancedFraudSignals?"?advancedFraudSignals=false":"",r=document.createElement("script");r.src="".concat(h).concat(t);var n=document.head||document.body;if(!n)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return n.appendChild(r),r},v=function(e,t){!e||!e._registerWrapper||e._registerWrapper({name:"stripe-js",version:"2.1.7",startTime:t})},l=null,x=function(e){return l!==null||(l=new Promise(function(t,r){if(typeof window=="undefined"||typeof document=="undefined"){t(null);return}if(window.Stripe&&e&&console.warn(m),window.Stripe){t(window.Stripe);return}try{var n=b();n&&e?console.warn(m):n||(n=k(e)),n.addEventListener("load",function(){window.Stripe?t(window.Stripe):r(new Error("Stripe.js not available"))}),n.addEventListener("error",function(){r(new Error("Failed to load Stripe.js"))})}catch(o){r(o);return}})),l},_=function(e,t,r){if(e===null)return null;var n=e.apply(void 0,t);return v(n,r),n},u=Promise.resolve().then(function(){return x(null)}),f=!1;u.catch(function(i){f||console.warn(i)});var d=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r];f=!0;var n=Date.now();return u.then(function(o){return _(o,t,n)})};var T=window.location.host.includes("webflow.id")?"stage":"prod",a="https://stage.ai-or-not.com";var y=`
