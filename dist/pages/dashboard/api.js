...
@keyframes fadeout {
  from {top: 30px; opacity: 1;}
  to {top: 0; opacity: 0;}
`,O=document.createElement("style");O.innerHTML=de;document.head.appendChild(O);var b=document.getElementById("toast");function ue(r){b.classList.remove("hide");let e=document.createElement("span");e.innerHTML="x",e.className="close-button",e.addEventListener("click",()=>{b.classList.add("hide"),window.location.href=`https://${window.location.host}/dashboard/settings`}),b.innerHTML=r,b.appendChild(e),b.classList.add("show")}var N=(r,e)=>{ue(`<p style="font-size: 1.5rem; padding: 2rem;">We are pleased to inform you that you currently have a credit of $${r} from a previous paid subscription after that we successfully update your plan to <span style="color: #aefc06; font-weight: bold ">${e.split(" ")[0]}</span>! If you have any questions please contact us.</p>`)};var Y=`
