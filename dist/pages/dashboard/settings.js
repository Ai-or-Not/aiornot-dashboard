...
`;function k(d){var C;let a=(C=document.getElementById("table"))==null?void 0:C.getElementsByTagName("tbody")[0],c=a==null?void 0:a.insertRow(a.rows.length),x=c==null?void 0:c.insertCell(0),P=c==null?void 0:c.insertCell(1),T=c==null?void 0:c.insertCell(2),S=c==null?void 0:c.insertCell(3),L=c==null?void 0:c.insertCell(4);x.innerHTML=`<p class="cell"> ${d.num} </p>`,P.innerHTML=`<p class="cell"> ${d.name} </p>`,T.innerHTML=`<p class="cell"> ${d.amount} </p>`,S.innerHTML=`<p class="cell" style="color: ${d.status==="paid"?"#00D924":"red"}" > ${d.status} </p>`,d.status!=="draft"&&(L.innerHTML=`<a class="cell" href="${d.invoice_link}" target="_blank" style="text-decoration: underline"> Invoice </a>`)}m.getTransactions().then(({invoices:d})=>{d.forEach((a,c)=>{k({num:c+1,name:a==null?void 0:a.created_dt,amount:`$${a==null?void 0:a.amount}`,status:a==null?void 0:a.status,invoice_link:a==null?void 0:a.link}),t.classList.remove("hide")})})};Z();})();
