"use strict";(()=>{function B(s){var e=s.split(".")[1],t=e.replace(/-/g,"+").replace(/_/g,"/"),n=decodeURIComponent(atob(t).split("").map(function(r){return"%"+("00"+r.charCodeAt(0).toString(16)).slice(-2)}).join(""));return JSON.parse(n)}var U="https://js.stripe.com/v3",H=/^https:\/\/js\.stripe\.com\/v3\/?(\?.*)?$/,C="loadStripe.setLoadParameters was called but an existing Stripe.js script already exists in the document; existing script parameters will be used",z=function(){for(var e=document.querySelectorAll('script[src^="'.concat(U,'"]')),t=0;t<e.length;t++){var n=e[t];if(H.test(n.src))return n}return null},F=function(e){var t=e&&!e.advancedFraudSignals?"?advancedFraudSignals=false":"",n=document.createElement("script");n.src="".concat(U).concat(t);var r=document.head||document.body;if(!r)throw new Error("Expected document.body not to be null. Stripe.js requires a <body> element.");return r.appendChild(n),n},Y=function(e,t){!e||!e._registerWrapper||e._registerWrapper({name:"stripe-js",version:"2.1.7",startTime:t})},g=null,V=function(e){return g!==null||(g=new Promise(function(t,n){if(typeof window=="undefined"||typeof document=="undefined"){t(null);return}if(window.Stripe&&e&&console.warn(C),window.Stripe){t(window.Stripe);return}try{var r=z();r&&e?console.warn(C):r||(r=F(e)),r.addEventListener("load",function(){window.Stripe?t(window.Stripe):n(new Error("Stripe.js not available"))}),r.addEventListener("error",function(){n(new Error("Failed to load Stripe.js"))})}catch(o){n(o);return}})),g},N=function(e,t,n){if(e===null)return null;var r=e.apply(void 0,t);return Y(r,n),r},R=Promise.resolve().then(function(){return V(null)}),j=!1;R.catch(function(s){j||console.warn(s)});var k=function(){for(var e=arguments.length,t=new Array(e),n=0;n<e;n++)t[n]=arguments[n];j=!0;var r=Date.now();return R.then(function(o){return N(o,t,r)})};var J=window.location.host.includes("webflow")?"stage":"prod",l=`https://${J}.ai-or-not.com`;var f=class{constructor(e,t){this.apiUrl=e,this.bearerToken=t}async get(e){let t=`${this.apiUrl}/${e}`;try{let n=await fetch(t,{method:"GET",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.bearerToken}`}});return await this.handleResponse(n)}catch(n){throw console.error("Error",n),n}}async post(e,t){let n=`${this.apiUrl}/${e}`;try{let r=await fetch(n,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.bearerToken}`},body:JSON.stringify(t)});return await this.handleResponse(r)}catch(r){throw console.error("Request error",r),r.status===429&&r.message.msg.type==="requests"&&alert(`It looks like you have reached your plan limit of ${r.message.msg.current_limit} requests. To continue, please upgrade to a new plan.`),r}}async postBinary(e,t){let n=`${this.apiUrl}/${e}`;try{let r=await fetch(n,{method:"POST",headers:{Accept:"application/json",Authorization:`Bearer ${this.bearerToken}`},body:t});return await this.handleResponse(r)}catch(r){throw console.error("Binary request error:",r),r.status===429&&r.message.msg.type==="requests"&&alert(`It looks like you have reached your plan limit of ${r.message.msg.current_limit} requests. To continue, please upgrade to a new plan.`),r}}async delete(e){let t=`${this.apiUrl}/${e}`;try{let n=await fetch(t,{method:"DELETE",headers:{accept:"*/*",Authorization:`Bearer ${this.bearerToken}`}});await this.handleResponse(n)}catch(n){throw console.error("Error when perform DELETE-request:",n),n}}async patch(e,t){let n=`${this.apiUrl}/${e}`;try{let r=await fetch(n,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${this.bearerToken}`},body:JSON.stringify(t)});return await this.handleResponse(r)}catch(r){throw console.error("\u041E\u0448\u0438\u0431\u043A\u0430 \u043F\u0440\u0438 \u0432\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u0438\u0438 PATCH-\u0437\u0430\u043F\u0440\u043E\u0441\u0430:",r),r}}async handleResponse(e){if(!e.ok){let t=await e.json();throw{status:e.status,message:t}}if(e.status!==204)return await e.json()}};var q=`
...
`,O=document.createElement("style");O.innerHTML=X;document.head.appendChild(O);a.init();p.subscriptionInfo().then(s=>{});h.classList.remove("hide");a.getUserInfo().then(s=>{s.is_verified?(h.innerHTML="Email has been verified",h.classList.remove("settings-edit"),h.disable=!0):(h.classList.remove("hide"),h.onclick=async()=>{h.classList.add("hide"),await a.sendVerifiedEmail(),alert("Email sent. Check your inbox.")})});Q.onclick=()=>{a.removeAuth(),localStorage.removeItem("_aion_in")};G.onclick=async()=>{if(confirm("Are you sure you want to delete your account?")){if(await a.init(),!await p.delete()){alert("Something went wrong. Please try again later.");return}localStorage.removeItem("_aion_in"),alert("Your account has been deleted."),window.location.href=`https://${window.location.host}/`}};K.innerHTML=`
...
`;function Z(s){var y;let e=(y=document.getElementById("table"))==null?void 0:y.getElementsByTagName("tbody")[0],t=e==null?void 0:e.insertRow(e.rows.length),n=t==null?void 0:t.insertCell(0),r=t==null?void 0:t.insertCell(1),o=t==null?void 0:t.insertCell(2),i=t==null?void 0:t.insertCell(3),u=t==null?void 0:t.insertCell(4);n.innerHTML=`<p class="cell"> ${s.num} </p>`,r.innerHTML=`<p class="cell"> ${s.name} </p>`,o.innerHTML=`<p class="cell"> ${s.amount} </p>`,i.innerHTML=`<p class="cell" style="color: ${s.status==="paid"?"#00D924":"red"}" > ${s.status} </p>`,u.innerHTML=`<a class="cell" href="${s.invoice_link}" target="_blank" style="text-decoration: underline"> Invoice </a>`}p.getTransactions().then(({invoices:s})=>{s.forEach((e,t)=>{Z({num:t+1,name:e==null?void 0:e.created_dt,amount:`$${e==null?void 0:e.amount}`,status:e==null?void 0:e.status,invoice_link:e==null?void 0:e.link}),W.classList.remove("hide")})});})();
