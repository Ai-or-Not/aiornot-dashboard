...
@keyframes fadeout {
  from {top: 30px; opacity: 1;}
  to {top: 0; opacity: 0;}
`,ve=document.createElement("style");ve.innerHTML=Ge;document.head.appendChild(ve);var $=document.getElementById("toast");function Je(i){$.classList.remove("hide");let e=document.createElement("span");e.innerHTML="x",e.className="close-button",e.addEventListener("click",()=>{$.classList.add("hide"),window.location.href=`https://${window.location.host}/dashboard/settings`}),$.innerHTML=i,$.appendChild(e),$.classList.add("show")}var we=(i,e)=>{Je(`<p style="font-size: 1.5rem; padding: 2rem;">We are pleased to inform you that you currently have a credit of $${i} from a previous paid subscription after that we successfully update your plan to <span style="color: #aefc06; font-weight: bold ">${e.split(" ")[0]}</span>! If you have any questions please contact us.</p>`)};var Ee=`
