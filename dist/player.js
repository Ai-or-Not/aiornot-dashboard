...
@keyframes fadeout {
  from {top: 30px; opacity: 1;}
  to {top: 0; opacity: 0;}
`,ge=document.createElement("style");ge.innerHTML=Ye;document.head.appendChild(ge);var M=document.getElementById("toast");function We(i,e="info"){M.classList.remove("hide");let t=document.createElement("span");t.innerHTML="x",t.className="close-button",t.addEventListener("click",()=>{M.classList.add("hide"),e!=="error"&&(window.location.href=`https://${window.location.host}/dashboard/settings`)}),M.innerHTML=i,M.appendChild(t),M.classList.add("show"),M.style.borderColor=e==="error"?"red":"#aefc06"}var fe=(i,e)=>{We(`<p style="font-size: 1.5rem; padding: 2rem;">We are pleased to inform you that you currently have a credit of $${i} from a previous paid subscription after that we successfully update your plan to <span style="color: #aefc06; font-weight: bold ">${e.split(" ")[0]}</span>! If you have any questions please contact us.</p>`)};var ve=`
